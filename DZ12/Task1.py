...
class Student:
    ...
    def __init__(self, name:str, patronymic :str, surname: str, *args, **kwargs):
        self.name = name
...
ob = Student("Анна", "Андреевна", "Андреева")
ob2 = Student("Ольга", "Олеговна", "Ольгина")
ob3 = Student("Александр", "Александрович", "Александров")
